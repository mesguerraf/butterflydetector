...
from . import data_manager, encoder, logs, optimize, transforms
...
def cli():
    ...
    group.add_argument('--debug-fields-indices', default=[], nargs='+', type=int,
                       help='indices of Butterfly fields to create debug plots for')
...
def main():
    ...
    train_loader, val_loader, pre_train_loader = data_manager.dataset_factory(
